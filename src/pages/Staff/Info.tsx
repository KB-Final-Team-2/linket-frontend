        ...
        <div className="w-[375px] h-[812px] relative overflow-hidden bg-white">
            ...
            <div className="w-[331px] h-[582px] absolute left-[22px] top-[125px] overflow-hidden border border-white">
                ...
                <div className="w-[331px] h-[100px] absolute left-0 top-0 overflow-hidden border-2 border-white">
                    ...
                    >
                        <path
                            d="M12.5 2.0835C6.75623 2.0835 2.08331 6.75641 2.08331 12.5002C2.08331 18.2439 6.75623 22.9168 12.5 22.9168C18.2437 22.9168 22.9166 18.2439 22.9166 12.5002C22.9166 6.75641 18.2437 2.0835 12.5 2.0835ZM12.5 20.8335C7.90519 20.8335 4.16665 17.095 4.16665 12.5002C4.16665 7.90537 7.90519 4.16683 12.5 4.16683C17.0948 4.16683 20.8333 7.90537 20.8333 12.5002C20.8333 17.095 17.0948 20.8335 12.5 20.8335Z"
                            fill="white"
                        />
                        <path
                        ...
                        />
                        <path
                            d="M12.5 18.7502C16.6667 18.7502 17.7084 14.5835 17.7084 14.5835H7.29169C7.29169 14.5835 8.33335 18.7502 12.5 18.7502Z"
                            fill="white"
                        />
                    </svg>
                    <svg
