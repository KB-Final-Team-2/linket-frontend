    ...
    return (
        <>
            ...
            <Content>
                ...
                <div className="flex flex-col w-full h-full justify-center items-center self-stretch flex-grow overflow-hidden">
                    {review.loading
                        ?
                        ...
                        <>
                            <div className="flex justify-start items-start self-stretch flex-grow-0 flex-shrink-0 h-[60px] overflow-hidden  border-b border-white">
                                <div className="text-place-center self-stretch flex-grow-0 flex-shrink-0 w-[80px] overflow-hidden border-r border-white text-base font-bold text-center text-white">
                                    시설<br />(좌석)
                                </div>
                                <div className="text-place-center w-full self-stretch flex-grow relative overflow-hidden gap-2.5 border-r  border-white text-base font-bold text-center text-white">
                                    {`${(eventReviewList.reduce((pre, cur) => { return pre + cur.rateFacilChair }, 0) / eventReviewList?.length).toFixed(1)}`}/5.0
                                </div>
                                <div className="text-place-center self-stretch flex-grow-0 flex-shrink-0 w-[80px] overflow-hidden border-r border-white text-base font-bold text-center text-white">
                                    시설<br />(화장실)
                                </div>
                                <div className="text-place-center w-full self-stretch flex-grow relative overflow-hidden gap-2.5  border-white text-base font-bold text-center text-white">
                            ...
                            <div className="flex justify-start items-start self-stretch flex-grow-0 flex-shrink-0 h-[60px] overflow-hidden  border-b border-white">
                                ...
                                </div><div className="text-place-center self-stretch flex-grow-0 flex-shrink-0 w-[80px] overflow-hidden border-r border-white text-base font-bold text-center text-white">
                                    직원<br />(티켓 발급)
                                </div>
                                <div className="text-place-center w-full self-stretch flex-grow relative overflow-hidden gap-2.5 text-base font-bold text-center text-white">
                            ...
                            <div className="flex flex-col justify-start items-start self-stretch flex-grow overflow-hidden">
                                <div className="text-place-center self-stretch flex-grow-0 flex-shrink-0 h-10 border-b border-white text-base font-bold text-left text-white px-3">
                                    기타 의견
                                </div>
                                <div className="flex flex-col justify-start items-start self-stretch flex-grow overflow-auto custom-toolbar">
                                    {eventReviewList.filter((review: ReviewWithUser) => review.reviewEtc !== undefined)?.map((v, i) => (
                                        <div key={i} className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative overflow-hidden p-2 border-y border-white text-base">
                                            {v.reviewEtc}
                                        </div>
                                    ))}
                                </div>
