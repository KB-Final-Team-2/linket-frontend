...
const EventRegister = () => {
    return (
        <div className="w-[375px] h-[812px] relative overflow-hidden bg-white">
            ...
            <div className="w-[331px] h-[571px] absolute left-[22px] top-[125px] overflow-hidden border border-white">
                <div className="w-[331px] h-[532px] absolute left-0 top-5 overflow-hidden">
                    <div className="w-[330px] h-[175px] absolute left-px top-[357px] overflow-hidden">
                    ...
                    <div className="w-[330px] h-[37px] absolute left-px top-[306px] overflow-hidden">
                    ...
                    <div className="w-[330px] h-[37px] absolute left-px top-[255px] overflow-hidden">
                        <p className="w-[115px] h-[37px] absolute left-0 top-0 text-[15px] font-bold text-center text-white">
                            행사 포스터
                        </p>
                        <div className="w-[215px] h-[37px] absolute left-[115px] top-0 overflow-hidden rounded-[9px] bg-[#c4c4c4]/[0.31]" />
                    </div>
                    <div className="w-[330px] h-[37px] absolute left-px top-[204px] overflow-hidden">
                        <p className="w-[115px] h-[37px] absolute left-0 top-0 text-[15px] font-bold text-center text-white">
                            행사 장소
                        </p>
                        <div className="w-[215px] h-[37px] absolute left-[115px] top-0 overflow-hidden rounded-[9px] bg-[#c4c4c4]/[0.31]" />
                    </div>
                    <div className="w-[330px] h-[37px] absolute left-px top-[153px] overflow-hidden">
                        <p className="w-[115px] h-[37px] absolute left-0 top-0 text-[15px] font-bold text-center text-white">
                            행사 종료일시
                        </p>
                    ...
                    <div className="w-[330px] h-[37px] absolute left-px top-[102px] overflow-hidden">
                        <p className="w-[115px] h-[37px] absolute left-0 top-0 text-[15px] font-bold text-center text-white">
                            행사 시작일시
                        </p>
                        <div className="w-[215px] h-[37px] absolute left-[115px] top-0 overflow-hidden rounded-[20px]">
                    ...
                    <div className="w-[330px] h-[37px] absolute left-px top-[51px] overflow-hidden">
                        <p className="w-[115px] h-[37px] absolute left-0 top-0 text-[15px] font-bold text-center text-white">
                            행사 분류
                        </p>
                    ...
                    <div className="w-[330px] h-[37px] absolute left-px top-0 overflow-hidden">
                        <p className="w-[115px] h-[37px] absolute left-0 top-0 text-[15px] font-bold text-center text-white">
                            행사명
                        </p>
                        <div className="w-[215px] h-[37px] absolute left-[115px] top-0 overflow-hidden rounded-[9px] bg-[#c4c4c4]/[0.31]" />
