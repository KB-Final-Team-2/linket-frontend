        ...
        <div className="w-[375px] h-[812px] relative overflow-hidden bg-white">
            ...
            <div className="w-[331px] h-[582px] absolute left-[22px] top-[125px] overflow-hidden border border-white">
                ...
                <div className="w-[331px] h-[100px] absolute left-0 top-0 overflow-hidden border-2 border-white">
                    ...
                    >
                        <path
                            d="M12.5 2.08325C6.75623 2.08325 2.08331 6.75617 2.08331 12.4999C2.08331 18.2437 6.75623 22.9166 12.5 22.9166C18.2437 22.9166 22.9166 18.2437 22.9166 12.4999C22.9166 6.75617 18.2437 2.08325 12.5 2.08325ZM12.5 20.8333C7.90519 20.8333 4.16665 17.0947 4.16665 12.4999C4.16665 7.90513 7.90519 4.16659 12.5 4.16659C17.0948 4.16659 20.8333 7.90513 20.8333 12.4999C20.8333 17.0947 17.0948 20.8333 12.5 20.8333Z"
                            fill="white"
                        />
                        <path
                            d="M8.85419 12.5C9.71713 12.5 10.4167 11.8004 10.4167 10.9375C10.4167 10.0746 9.71713 9.375 8.85419 9.375C7.99124 9.375 7.29169 10.0746 7.29169 10.9375C7.29169 11.8004 7.99124 12.5 8.85419 12.5Z"
                            fill="white"
                        />
                        <path
                            d="M16.1385 12.4854C16.9974 12.4854 17.6937 11.7891 17.6937 10.9302C17.6937 10.0713 16.9974 9.375 16.1385 9.375C15.2796 9.375 14.5833 10.0713 14.5833 10.9302C14.5833 11.7891 15.2796 12.4854 16.1385 12.4854Z"
                            fill="white"
                        />
                        <path
                            d="M12.5 18.7499C16.6667 18.7499 17.7084 14.5833 17.7084 14.5833H7.29169C7.29169 14.5833 8.33335 18.7499 12.5 18.7499Z"
                            fill="white"
                        />
                    </svg>
                    <svg
            ...
            <div className="w-[331px] h-[125px] absolute left-[22px] top-0 overflow-hidden">
                ...
                <div className="w-[331px] h-[95px] absolute left-0 top-[30px] overflow-hidden">
                    ...
                    <div className="w-[257px] h-[95px] absolute left-0 top-0 overflow-hidden">
                        <div className="w-10 h-[95px] absolute left-0 top-0 overflow-hidden" />
                        <div className="w-[217px] h-[95px] absolute left-[50px] top-0 overflow-hidden">
                            <p className="w-[217px] h-[95px] absolute left-0 top-0 text-[40px] font-medium text-left text-white">
                                김고객
                            </p>
                        </div>
                    </div>
