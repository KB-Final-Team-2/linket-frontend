...
import { DUMMY_TICKET1, DUMMY_TICKET2, DUMMY_TICKETWITHEVENT, INIT_TICKET, Ticket, TicketWithEvent, TicketWithUser } from "../../interface/Ticket";
import TicketList from "../../components/List/TicketList";
import { getTicket, getTicketList, getUserTicketList, setEventTicketList, setTicket, setTicketList } from "../../redux/slice/ticketSlice";
			...
			<div className="w-[375px] h-[812px] relative overflow-hidden flex flex-col justify-center items-center">
				{ticketData === INIT_TICKET ?
					<div className="w-[331px] h-full overflow-hidden">
						...
						<div className="w-full h-[580px] overflow-hidden border-t border-b flex flex-col">
							...
							<div className="w-full h-full overflow-auto flex flex-col gap-3 custom-toolbar px-5">
								{userTicketList.length === 0
									...
									<div className="w-full h-full text-center flex flex-col justify-center items-center">
										...
										>
											<g clip-path="url(#clip0_951_28398)">
												<path
