    ...
    return (
        <div className="w-[375px] h-[812px] relative overflow-hidden bg-white">
            ...
            <div className="w-[375px] h-[53px] absolute left-0 top-[759px] overflow-hidden bg-[#454545]">
                ...
                >
                    <path
                        d="M2.66663 23.3248H21.3333V20.4405H2.66663V23.3248ZM2.66663 17.5561H21.3333V14.6718H2.66663V17.5561ZM2.66663 3.13437V6.01872H21.3333V3.13437H2.66663ZM2.66663 11.7874H21.3333V8.90308H2.66663V11.7874Z"
                        fill="white"
                    />
                </svg>
