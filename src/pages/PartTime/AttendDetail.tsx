const AttendDetail = () => {
    return (
        <div className="w-[375px] h-[812px] relative overflow-hidden bg-white">
            ...
            <div className="w-[100px] h-[60px] absolute left-[260px] top-[87px] overflow-hidden rounded-[20px] bg-[#545454] border-[3px] border-white">
                <div className="w-20 h-[30px] absolute left-2.5 top-[30px] overflow-hidden">
                    <p className="w-20 h-[30px] absolute left-0 top-0 text-[15px] font-medium text-center text-white">
                        퇴근 활성화
                    </p>
                </div>
                <div className="w-20 h-[30px] absolute left-2.5 top-0 overflow-hidden">
                    <svg
                        width={80}
                        height={1}
                        viewBox="0 0 80 1"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                        className="absolute left-[-1px] top-[29px]"
                        preserveAspectRatio="none"
                    >
