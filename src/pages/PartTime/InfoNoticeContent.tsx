    ...
    return (
        <div className="w-[375px] h-[812px] relative overflow-hidden bg-white">
            ...
            <div className="w-[375px] h-[53px] absolute left-0 top-[759px] overflow-hidden bg-[#454545]">
                ...
                >
                    <path
                        d="M2.66669 23.3249H21.3334V20.4405H2.66669V23.3249ZM2.66669 17.5562H21.3334V14.6718H2.66669V17.5562ZM2.66669 3.1344V6.01875H21.3334V3.1344H2.66669ZM2.66669 11.7875H21.3334V8.90311H2.66669V11.7875Z"
                        fill="white"
                    />
                </svg>
