        ...
        <div className="w-[375px] h-[812px] relative overflow-hidden bg-white">
            ...
            <div className="w-[331px] h-[580px] absolute left-[22px] top-[125px] overflow-hidden border border-white">
                <div className="w-[331px] h-[300px] absolute left-0 top-0 overflow-hidden">
                    ...
                    <div className="flex justify-start items-start absolute left-[293px] top-[37px] overflow-hidden gap-2.5 p-2">
                        <svg
                            width={19}
                            height={16}
                            viewBox="0 0 19 16"
                    ...
                    <div className="flex justify-start items-start w-[330px] h-[263px] absolute left-0 top-[37px] overflow-hidden gap-2.5 p-2.5 bg-[#c4c4c4]/[0.31]">
                ...
                <div className="w-[331px] h-[37px] absolute left-0 top-[300px] overflow-hidden">
                    <div className="w-[331px] h-[37px] absolute left-0 top-0 overflow-hidden">
                        <div className="w-[331px] h-[37px] absolute left-0 top-0 overflow-hidden">
                            <p className="w-[331px] h-[37px] absolute left-0 top-0 text-[15px] font-bold text-left text-white">
                                처음 일정 이렇게 잡은 사람은 누구인가요?
                            </p>
                        </div>
                        <svg
                            width={331}
                    ...
                    <div className="flex justify-start items-start absolute left-[331px] top-0 overflow-hidden gap-2.5 p-2">
                        ...
                        >
                            <path
                                d="M16.8619 1.25037L9.50073 14.0004L2.13952 1.25037L16.8619 1.25037Z"
                                fill="#FF6000"
                                stroke="#454545"
                                strokeWidth={2}
                            />
                ...
                <div className="w-[331px] h-[37px] absolute left-0 top-[337px] overflow-hidden">
                    <div className="w-[331px] h-[37px] absolute left-0 top-0 overflow-hidden">
                        <div className="w-[331px] h-[37px] absolute left-0 top-0 overflow-hidden">
                            <p className="w-[331px] h-[37px] absolute left-0 top-0 text-[15px] font-bold text-left text-white">
                                5월 31일까지 마무리할 수 있을까요?
                            </p>
                        </div>
                        <svg
                            width={331}
                ...
                <div className="w-[331px] h-[37px] absolute left-0 top-[374px] overflow-hidden">
                    <div className="w-[331px] h-[37px] absolute left-0 top-0 overflow-hidden">
                        <div className="w-[331px] h-[37px] absolute left-0 top-0 overflow-hidden">
                            <p className="w-[331px] h-[37px] absolute left-0 top-0 text-[15px] font-bold text-left text-white">
                                안되면 되게 하라고 하면 어떡하죠?
                ...
                <div className="w-[331px] h-[37px] absolute left-0 top-[411px] overflow-hidden">
                    <div className="w-[331px] h-[37px] absolute left-0 top-0 overflow-hidden">
                        <div className="w-[331px] h-[37px] absolute left-0 top-0 overflow-hidden">
                            <p className="w-[331px] h-[37px] absolute left-0 top-0 text-[15px] font-bold text-left text-white">
                                이번 주에는 칼퇴할 수 있을까요?
                ...
                <div className="w-[331px] h-[37px] absolute left-0 top-[448px] overflow-hidden">
                    <div className="w-[331px] h-[37px] absolute left-0 top-0 overflow-hidden">
                        <div className="w-[331px] h-[37px] absolute left-0 top-0 overflow-hidden">
                            <p className="w-[331px] h-[37px] absolute left-0 top-0 text-[15px] font-bold text-left text-white">
                                프로젝트로 인한 산재처리 가능한가요?
            ...
            <div className="w-[375px] h-[53px] absolute left-0 top-[759px] overflow-hidden bg-[#454545]">
                ...
                >
                    <path
                        d="M2.66666 23.3249H21.3333V20.4405H2.66666V23.3249ZM2.66666 17.5562H21.3333V14.6718H2.66666V17.5562ZM2.66666 3.1344V6.01875H21.3333V3.1344H2.66666ZM2.66666 11.7875H21.3333V8.90311H2.66666V11.7875Z"
                        fill="white"
                    />
                </svg>
...
export default InfoFAQContents;